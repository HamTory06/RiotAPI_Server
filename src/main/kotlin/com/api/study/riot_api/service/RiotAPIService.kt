            ...
            for (i in 0 until info.participants.size) {
                if (info.participants[i].puuid == puuid) {
                    val matchInformation = MatchInformation(
                        ...
                        championKill = info.participants[i].kills,
                        championDeath = info.participants[i].deaths,
                        championAssist = info.participants[i].assists,
                        championLevel = info.participants[i].champLevel,
                        championName = info.participants[i].championName,
                        summoner1Id = info.participants[i].summoner1Id,
                        summoner2Id = info.participants[i].summoner2Id,
